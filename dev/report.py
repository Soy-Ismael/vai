...
def create_report(ruta_archivo:str='excel\\', nombre_archivo:str = 'supermarket_sales.xlsx'):
    try:
        # 1. Leer archivo excel
        excel_archive = pd.read_excel(ruta_archivo+nombre_archivo)
        ...
        tabla_pivot.to_excel(ruta_archivo+nombre_archivo_procesado, startrow=4, startcol=1, sheet_name=nombre_hoja)
        ...
        wb = load_workbook(ruta_archivo+nombre_archivo_procesado)
        ...
        # Guardar gráfico
        wb.save(ruta_archivo+nombre_archivo_procesado) # Guardamos el archivo con el mismo nombre, esto indica que se guarda el mismo archivo y no se crea otro nuevo
        return True
