...
voiceEngine.addEventListener("change", () => {
    if (voiceEngine.value == 'azure'){
        azureApiKey.removeAttribute('disabled')
        azureApiKey.classList.remove('disabled')
        console.log(voiceEngine.value);
    }else{
        azureApiKey.setAttribute('disabled', true)
        azureApiKey.classList.add('disabled')
        console.log(voiceEngine.value);
    }
});
