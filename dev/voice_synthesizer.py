...
def synthesize_to_speaker(text:str='Hola mundo', voice:str='es-MX-DaliaNeural', recognition_language:str='es-MX', azure_api_key:str=get_key('dev/.env',"AZURE_API_KEY"), region:str='eastus'):
